...
Food.create(category_id: 9, unit: "cup(s)", name: "pasta")
...
VasQuestion.create(order: 3, prompt_left: "When or if I eat ", prompt_right: " even when I am not hungry (for example, going out to eat after already eating a meal or eating more snacks after a meal)")
VasQuestion.create(order: 4, prompt_left: "I do not eat large amounts of ", prompt_right: ".")
VasQuestion.create(order: 5, prompt_left: "When or if I eat ", prompt_right: " until I feel physically ill (for example, feeling sick or nauseated, uncomfortably full, wanting to throw up, or pain)")
...
VasQuestion.create(order: 10, prompt_left: "When or if I eat ", prompt_right: " (for example, you will drive to the store to buy chocolate candy bars even though you have other food at home)")
...
VasQuestion.create(order: 14, prompt_left: "I think about not eating ", prompt_right: " (for example, while I am eating chips, I think about only eating a small handful)")
VasQuestion.create(order: 15, prompt_left: "When or if I eat ", prompt_right: " throughout the day (for example, I have a can of soda on my desk all day long)")
VasQuestion.create(order: 16, prompt_left: "When or if I eat ", prompt_right: " in such large amounts that I have had to spend time dealing with the negative consequences (for example, physical discomfort, sluggish, depressed, etc.) instead of working, spending time with family or friends, or participating in other activities that I enjoy ")
...
VasQuestion.create(order: 20, prompt_left: "When or if I eat ", prompt_right: " I eat compared to before to feel satisfied (for example, I need to drink a 32 oz soda instead of 16 oz to feel satisfied) ")
...
VasQuestion.create(order: 23, prompt_left: "I eat ", prompt_right: " to deal with withdrawal symptoms such as anxiety, stress, or agitation (for example, when I am stressed at work, I eat more candy bars at my desk)")
